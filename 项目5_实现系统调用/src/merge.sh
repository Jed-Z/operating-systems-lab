...
cd lib
nasm -f elf32 syslib.asm -o ../temp/syslib.a.o
gcc -c -m16 -march=i386 -masm=intel -nostdlib -ffreestanding -mpreferred-stack-boundary=2 -lgcc -shared syslib.c -o ../temp/syslib.c.o
cd ..
...
ld -m elf_i386 -N -Ttext 0x8000 --oformat binary ./temp/osstarter.o ./temp/liba.o ./temp/kernel.o ./temp/syslib.a.o ./temp/syslib.c.o ./temp/hotwheel.o -o ./temp/kernel.bin
rm ./temp/*.o
...
dd if=./temp/intcaller.bin of=JedOS_v1.3.img bs=512 seek=26 count=2 2> /dev/null
