...
nasm -f elf32 keyouch.asm -o ../temp/keyouch.o
cd ..
...
ld -m elf_i386 -N -Ttext 0x8000 --oformat binary ./temp/osstarter.o ./temp/kernel.o ./temp/liba.o ./temp/hotwheel.o ./temp/keyouch.o -o ./temp/kernel.bin
rm ./temp/*.o
